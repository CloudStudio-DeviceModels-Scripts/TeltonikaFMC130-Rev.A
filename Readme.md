...
# Parsing + Configuration Script – Teltonika FMC130  - Rev. A

This **Parsing + Configuration** script is designed for the **Teltonika FMC130 ** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – Teltonika FMC130  Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **Teltonika FMC130 ** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
